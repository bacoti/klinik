...
const DoctorDashboard: React.FC = () => {
  ...
  const mockData = {
    ...
    upcomingAppointments: [
      { id: 1, time: '09:00', patient: 'Ahmad Wijaya', type: 'Regular', status: 'waiting' },
      { id: 2, time: '09:30', patient: 'Sari Dewi', type: 'Follow-up', status: 'screening' },
      { id: 3, time: '10:00', patient: 'Budi Santoso', type: 'Emergency', status: 'registered' },
      { id: 4, time: '10:30', patient: 'Maya Sari', type: 'Regular', status: 'registered' }
    ],
    recentExaminations: [
      { id: 1, patient: 'John Doe', diagnosis: 'Hypertension', time: '1 hour ago' },
      { id: 2, patient: 'Jane Smith', diagnosis: 'Common Cold', time: '2 hours ago' },
      { id: 3, patient: 'Bob Wilson', diagnosis: 'Diabetes Check', time: '3 hours ago' }
    ]
  };
          ...
          <CardContent>
            <div className="space-y-4">
              {mockData.upcomingAppointments.map((appointment) => (
                <div key={appointment.id} className="flex items-center justify-between p-4 rounded-lg border border-gray-100 hover:bg-gray-50 transition-colors">
                  ...
                  <span className={`px-3 py-1 rounded-full text-xs font-medium ${
                    ...
                    appointment.status === 'screening' ? 'bg-blue-100 text-blue-800' :
          ...
          <CardContent>
            <div className="space-y-4">
              {mockData.recentExaminations.map((exam) => (
                <div key={exam.id} className="flex items-center space-x-4 p-4 rounded-lg border border-gray-100 hover:bg-gray-50 transition-colors">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-sm text-gray-500">{exam.diagnosis}</p>
